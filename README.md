...
<details>
<summary>TC-004 Раздел " отображение данных в посте (не авторизованный пользователь) </summary>
  
**Предусловие**:
1. Открыт сайт https://stiletto.blog. 
2. Пользователь не авторизован. Открыт раздел [Раздел](#Section_1)  

**Шаги**:
1. Выбрать любой пост, кликнуть на элемент [Способ перехода](#Click_1) 
2. После загрузки данных на странице проверить отображение элементов 
**ОР**: Отображается :
- логотип сайта (кликабельный)
- кнопки разделов "Блоги" и "Неглавная"
...
**Тестовые данные**:
***
№ |Раздел <a name="Section_1"/> |Способ перехода <a name="Click_1"/>  |
|:--:|:--|:---|
...
<details>
<summary>TC-005 отображение данных в посте (авторизованный пользователь) </summary>
